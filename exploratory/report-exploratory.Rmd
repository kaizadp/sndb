...
This .md file contains the output report. For the code, refer to the [.Rmd file](https://github.com/kaizadp/sndb/blob/main/exploratory/report-exploratory.md).
...
of the 2693 datapoints, 2334 data points are in the top 20 cm (lyr_bot >= 20)
